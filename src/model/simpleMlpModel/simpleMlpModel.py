...
#                                        dtype=tf.float32)
        #            self.conf.config_dict['NET_CONFIG'][0]['N_UNITS'] = INPUT_SPACE
        #            self.conf.config_dict['NET_CONFIG'][-1]['N_UNITS'] = OUTPUT_SPACE
    ...
    def update(self, sess, input, label):
        ...
        batch_count = len(input)  # // self.conf.config_dict['BATCH_SIZE']
