...
if __name__ == '__main__':
    from config.configSet_Pendulum_no_dyna import CONFIG_SET_PENDULUM_NO_DYNA, \
        MODEL_NET_WORK_CONFIG_DICT_PENDULUM_NO_DYNA
    from config.configSet_MountainCarContinuous_no_dyna import CONFIG_SET_MOUNTAIN_CAR_CONTINUOUS_CONFIG_NO_DYNA, \
        MODEL_NET_WORK_CONFIG_DICT_MOUNTAIN_CAR_CONTINUOUS_NO_DYNA
    from config.configSet_Swimmer_no_dyna import CONFIG_SET_SWIMMER_NO_DYNA, MODEL_NET_WORK_CONFIG_DICT_SWIMMER_NO_DYNA
    from config.configSet_Reacher_no_dyna import CONFIG_SET_REACHER_NO_DYNA, MODEL_NET_WORK_CONFIG_DICT_REACHER_NO_DYNA
    from config.configSet_HalfCheetah_no_dyna import CONFIG_SET_HALFCHEETAH_NO_DYNA, \
        MODEL_NET_WORK_CONFIG_DICT_HALFCHEETAH_NO_DYNA

    # Pendulum-v0
    #
    # run_single_experiment(game_env_name='Pendulum-v0',
    #                       cuda_device=0,
    #                       config_set_path=CONFIG_SET_PENDULUM_NO_DYNA,
    #                       model_config_dict=MODEL_NET_WORK_CONFIG_DICT_PENDULUM_NO_DYNA,
    ...
    #                       cuda_device=2,
    #                       config_set_path=CONFIG_SET_MOUNTAIN_CAR_CONTINUOUS_CONFIG_NO_DYNA,
    #                       model_config_dict=MODEL_NET_WORK_CONFIG_DICT_MOUNTAIN_CAR_CONTINUOUS_NO_DYNA,
    #                       target_model_type='DDPG')
    ...
    #                       cuda_device=2,
    #                       config_set_path=CONFIG_SET_REACHER_NO_DYNA,
    #                       model_config_dict=MODEL_NET_WORK_CONFIG_DICT_REACHER_NO_DYNA,
    ...
    #                       cuda_device=2,
    #                       config_set_path=CONFIG_SET_HALFCHEETAH_NO_DYNA,
    #                       model_config_dict=MODEL_NET_WORK_CONFIG_DICT_HALFCHEETAH_NO_DYNA,
    #                       target_model_type='TRPO')
